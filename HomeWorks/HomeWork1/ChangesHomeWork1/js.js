...
console.log('Положение второго пробела' + ' ' + string.indexOf(' ', string.indexOf(' ')+1));// Если в строке будет более чем 2 пробела то покажет именно второй
...
let newString = string.slice(0,-6);// сокращенная запись
